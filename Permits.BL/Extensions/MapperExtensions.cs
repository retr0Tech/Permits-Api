...
namespace Permits.BL.Extensions
{
    ...
    {
        public static Profile _CreateMap_WithConventions_FromAssemblies<T, TDto>(this Profile profile, bool reverseMap = true) where T : class, IBaseEntity where TDto : class, IBaseDto
        {
